package archiviste.view
{
	 ...
	 *
	 * archiviste.view.JeuIdentifierSerieView
	 */
	public class JeuIdentifierSerieView extends Sprite
	{
		...
		public function JeuIdentifierSerieView()
		{
			super();
		...
		public function setModel(model:OG_IdentifierDoc):void {
			var i:int = 0;
