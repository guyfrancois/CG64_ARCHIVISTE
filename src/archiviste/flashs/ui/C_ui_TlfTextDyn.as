package archiviste.flashs.ui
{
	 ...
	 */
	public class C_ui_TlfTextDyn extends Sprite
	{
		
		private var _text:String;
		protected var fltTF:TLFTextField;
		public function C_ui_TlfTextDyn()
		{
			super();
		
			for (var i:int = 0; i < numChildren; i++) 
			{
				if (getChildAt(i) is TLFTextField) {
					fltTF = getChildAt(i) as TLFTextField; 
				}
			}
			
			if (fltTF==null) {
				fltTF = new TLFTextField();
				addChild(fltTF);
			}
