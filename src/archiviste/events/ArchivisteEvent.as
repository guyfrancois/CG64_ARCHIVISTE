package archiviste.events
{
	 ...
	 */
	public class ArchivisteEvent extends DataBringerEvent
	{
		static protected const EVENT_CHANNEL_NAME:String = 'archiviseEventChannel';
		
		
		public function ArchivisteEvent(type:String, initialData:Object=null, bubbles:Boolean=false, cancelable:Boolean=false)
		{
		...
		{
			ArchivisteEvent.channel.dispatchEvent(this);
		}
